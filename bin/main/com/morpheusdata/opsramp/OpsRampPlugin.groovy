...
class OpsRampPlugin extends Plugin {
	...
	@Override
	void initialize() {
		OpsRampTaskProvider opsRampTaskProvider = new OpsRampTaskProvider(this, morpheus)
		this.pluginProviders.put(opsRampTaskProvider.code, opsRampTaskProvider)
		OpsRampIntegrationProvider opsRampIntegrationProvider = new OpsRampIntegrationProvider(this, morpheus)
		this.pluginProviders.put(opsRampIntegrationProvider.code, opsRampIntegrationProvider)
		this.setName("OpsRamp Plugin")
		this.setDescription("Instance tab plugin displaying OpsRamp data")
